...
download_file('https://raw.githubusercontent.com/BasmahSource/Basmah/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/BasmahSource/Basmah/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/BasmahSource/Basmah/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/BasmahSource/Basmah/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(basmah..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(basmah..':MONSHA_Group:'..ChatID,UserID) then
var = ' المنشىء اساسي👷🏽' 
elseif redis:sismember(basmah..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(basmah..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(basmah..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(basmah..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(basmah..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(basmah..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(basmah..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(basmah..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(basmah..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(basmah..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(basmah..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(basmah..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(basmah..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
function TagAll(msg)
  ...
  local monshaas = redis:smembers(basmah..':MONSHA_Group:'..msg.chat_id_)
...
for k,v in pairs(mmez) do
  ...
  message = message ..i.. '-l ['..info.username..'](tg://user?id='..v..') \n'
  end
...
local info  = redis:hgetall(basmah..'username:'..v)
local count = redis:scard(basmah..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](tg://user?id='..v..') l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
function conslist(msg)
    ...
    message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`) \n'
      ...
      message = message ..k.. '-l ['..info.username..'](tg://user?id='..v..') l » (`' ..v.. '`) \n'
    end
    end
    end
...
if redis:sismember(basmah..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(basmah..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(basmah..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(basmah..'gban_users',User) then 
return true 
else
return false
end 
...
if not msg.Admin and not msg.Special then -- للاعضاء فقط  
  local list = redis:smembers(basmah..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(basmah..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(basmah..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(basmah..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(basmah..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(basmah..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(basmah..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..basmah..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(basmah..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(basmah..'group:name'..GroupS) or '')
...
local admins = redis:smembers(basmah..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(basmah..'username:'..value)
if info then 
...
local creator = redis:smembers(basmah..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(basmah..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(basmah..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(basmah..'group:name'..v)
if info then 
...
redis:del(
basmah..'group:add'..id_group,
basmah..'lock_link'..id_group, 
basmah..'lock_id'..id_group,
basmah..'lock_spam'..id_group, 
basmah..'lock_webpage'..id_group,
basmah..'lock_markdown'..id_group,
basmah..'lock_flood'..id_group,
basmah..'lock_bots'..id_group,
basmah..'mute_forward'..id_group,
basmah..'mute_contact'..id_group,
basmah..'mute_location'..id_group,
basmah..'mute_document'..id_group,
basmah..'mute_keyboard'..id_group,
basmah..'mute_game'..id_group,
basmah..'mute_inline'..id_group,
basmah..'lock_username'..id_group,
basmah..'num_msg_max'..id_group,
basmah..'mute_text'..id_group,
basmah..'admins:'..id_group,
basmah..':Filter_Word:'..id_group,
basmah..'banned:'..id_group,
basmah..'is_silent_users:'..id_group,
basmah..'whitelist:'..id_group,
basmah..':MONSHA_BOT:'..id_group,
basmah..'owners:'..id_group,
basmah..'replay'..id_group,
basmah..':MONSHA_Group:'..id_group
)
redis:srem(basmah..'group:ids',id_group)
end
...
redis:sadd(basmah..'admins:'..arg.chat_id_,data.id_)
...
local GroupUsers = tonumber(redis:get(basmah..':addnumberusers') or 0)
...
redis:mset(
basmah..'group:add'..arg.chat_id_,true,
basmah..'lock_link'..arg.chat_id_,true, 
basmah..'lock_id'..arg.chat_id_,true,
basmah..'lock_spam'..arg.chat_id_,true,
basmah..'lock_webpage'..arg.chat_id_,true,
basmah..'lock_markdown'..arg.chat_id_,true,
basmah..'lock_flood'..arg.chat_id_,true,
basmah..'lock_bots'..arg.chat_id_,true,
basmah..'mute_forward'..arg.chat_id_,true,
basmah..'mute_contact'..arg.chat_id_,true,
basmah..'mute_location'..arg.chat_id_,true,
basmah..'mute_document'..arg.chat_id_,true,
basmah..'mute_keyboard'..arg.chat_id_,true,
basmah..'mute_game'..arg.chat_id_,true,
basmah..'mute_inline'..arg.chat_id_,true,
basmah..'lock_username'..arg.chat_id_,true,
basmah..'num_msg_max'..arg.chat_id_,5, 
basmah..'lock_edit'..arg.chat_id_,true,
basmah..'replay'..arg.chat_id_,true,
basmah.."lock_KickBan"..msg.chat_id_,true,
basmah.."lock_mmno3"..msg.chat_id_,true,
basmah.."lock_KickBan"..msg.chat_id_,true,
basmah.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(basmah..'group:ids',arg.chat_id_) 
redis:sadd(basmah..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(basmah..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(basmah..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:sadd(basmah..':tqeed:'..ChatID,UserID)
return send_msg(ChatID,'👤*¦* العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تم تقييد العضو\n✓',UserID)
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(basmah..':tqeed:'..ChatID,UserID)
return send_msg(ChatID,'👤*¦* العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تم فك تقييد العضو\n✓',UserID)
end
if cmd == "setwhitelist" then
if redis:sismember(basmah..'whitelist:'..ChatID,UserID) then 
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ انه بالتأكيد من عضو مميز \n✓️',MsgID)  
end
redis:hset(basmah..'username:'..UserID, 'username', Resolv)
redis:sadd(basmah..'whitelist:'..ChatID,UserID)
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تمت ترقيته ليصبح عضو مميز \n✓️',MsgID)  
end
if cmd == "remwhitelist" then
if not redis:sismember(basmah..'whitelist:'..ChatID,UserID) then 
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ انه بالتأكيد ليس من عضو مميز \n✓️',MsgID)  
end
redis:srem(basmah..'whitelist:'..ChatID,UserID)
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تمت تنزيله من عضو مميز \n✓️',MsgID)  
end
if cmd == "setmnsha" then
if redis:sismember(basmah..':MONSHA_BOT:'..ChatID,UserID) then 
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ انه بالتأكيد منشىء \n✓️',MsgID)  
end
redis:hset(basmah..'username:'..UserID, 'username', Resolv)
redis:sadd(basmah..':MONSHA_BOT:'..ChatID,UserID)
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تمت ترقيته ليصبح منشىء في البوت \n✓️',MsgID)  
end
if cmd == "remmnsha" then
if not redis:sismember(basmah..':MONSHA_BOT:'..ChatID,UserID) then 
...
if redis:sismember(basmah..'owners:'..ChatID,UserID) then 
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ انه بالتأكيد مدير \n✓️',MsgID)  
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(basmah..'username:'..UserID, 'username', Resolv)
redis:sadd(basmah..'owners:'..ChatID,UserID)
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تمت ترقيته ليصبح مدير \n✓️',MsgID)  
end
if cmd == "remowner" then
if not redis:sismember(basmah..'owners:'..ChatID,UserID) then 
...
if cmd == "promote" then
if redis:sismember(basmah..'admins:'..ChatID,UserID) then 
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ انه بالتأكيد ادمن \n✓️',MsgID)  
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(basmah..'username:'..UserID, 'username', Resolv)
redis:sadd(basmah..'admins:'..ChatID,UserID) 
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تمت ترقيته ليصبح ادمن \n✓️',MsgID)  
end
if cmd == "demote" then
if not redis:sismember(basmah..'admins:'..ChatID,UserID) then 
...
if cmd == "Upmonsh" then
if redis:sismember(basmah..':MONSHA_Group:'..ChatID,UserID) then 
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ انه بالتأكيد منشىء اساسي \n✓️',MsgID)  
end
redis:hset(basmah..'username:'..UserID,'username',USERNAME)
redis:sadd(basmah..':MONSHA_Group:'..ChatID,UserID)
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تمت ترقيته ليصبح منشىء اساسي المجموعه \n✓️',MsgID)  
end

if cmd == "Dwmonsh" then
if not redis:sismember(basmah..':MONSHA_Group:'..ChatID,UserID) then 
return send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ انه بالتأكيد ليس منشىء اساسي \n✓️',MsgID)  
end
redis:srem(basmah..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(basmah..'username:'..UserID, 'username', Resolv)
redis:sadd(basmah..'banned:'..ChatID,UserID)
...
send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تم بالتأكيد الغاء حظره \n✓️',MsgID)  
else
send_msg(ChatID,'👤¦ العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تم الغاء حظره \n✓️',MsgID)  
end
redis:hset(basmah..'username:'..UserID, 'username', Resolv)
redis:srem(basmah..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(basmah..'username:'..UserID, 'username', Resolv)
redis:sadd(basmah..'is_silent_users:'..ChatID,UserID)
return send_msg(ChatID,'👤*¦* العضو » ['..USERNAME..'](tg://user?id='..UserID..') \n🎫¦ الايدي » {`'..UserID..'`}\n🛠¦ تم كتمه من المجموعة\n✓',UserID) 
end
...
redis:hset(basmah..'username:'..UserID, 'username', Resolv)
redis:srem(basmah..'is_silent_users:'..ChatID,UserID)
...
if cmd == "tfa3l" then  
  local maseegs = redis:get(basmah..'msgs:'..UserID..':'..ChatID) or 1
  local edited = redis:get(basmah..':edited:'..ChatID..':'..UserID) or 0
  local content = redis:get(basmah..':adduser:'..ChatID..':'..UserID) or 0
  if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
if rinkuser == 8 then return send_msg(ChatID,"👲🏼*¦* العضو » ["..USERNAME.."](tg://user?id="..UserID..") \n🎫*¦* الايدي » {`"..UserID.."`}\n🛠*¦* انه اساسا عضو \n✓️",MsgID)  end
huk = false
...
elseif msg.Admin then 
  ...
  huk = true
    ...
    if not huk then send_msg(ChatID,"👲🏼*¦* العضو » ["..USERNAME.."](tg://user?id="..UserID..") \n🎫¦ الايدي » {`"..UserID.."`} \n"..DonisDown.."\n✓️",MsgID) end
...
.."\n📝¦ التعديل » "..(redis:get(basmah..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(basmah..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(basmah..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(basmah..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(basmah..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(basmah..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(basmah..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(basmah..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(basmah..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(basmah..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(basmah..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(basmah..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(basmah..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(basmah..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(basmah..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(basmah..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(basmah..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(basmah..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(basmah..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(basmah..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(basmah..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(basmah..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(basmah..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(basmah..'mute_document'..msg.chat_id_) or 'false')
...
local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(basmah..'welcome:get'..msg.chat_id_) or 'false')
.."\n*💬¦*  الردود » "..(redis:get(basmah..'replay'..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(basmah..'lock_woring'..msg.chat_id_) or 'false')
.."\n*🎫¦* الايدي » "..(redis:get(basmah..'lock_id'..msg.chat_id_) or 'false')
.."\n*🎫¦* الرابط » "..(redis:get(basmah..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*🎫¦* المغادره » "..(redis:get(basmah..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🎫¦* الحظر » "..(redis:get(basmah..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🎫¦* الحمايه » "..(redis:get(basmah..'antiedit'..msg.chat_id_) or 'false')
.."\n*🎫¦* التاك للكل » "..(redis:get(basmah..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*🎫¦* الايدي بالصوره » "..(redis:get(basmah..'idphoto'..msg.chat_id_) or 'false')
.."\n*🎫¦* التحقق » "..(redis:get(basmah.."lock_check"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(basmah..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(basmah..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(basmah..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(basmah..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(basmah..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(basmah..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(basmah..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(basmah..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(basmah..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
